...
List<NavigationBarModel> initNavigationBarModel() {
  return <NavigationBarModel>[
    NavigationBarModel(
        ...
        activeImage: normalImageArray[0],
        title: navNameArray[0]),
    NavigationBarModel(
        varietyAction: false,
        normalImage: normalImageArray[1],
        activeImage: normalImageArray[1],
        title: navNameArray[1]),
    NavigationBarModel(
        varietyAction: true,
        normalImage: normalImageArray[2],
        activeImage: normalImageArray[2],
        title: navNameArray[2]),
    NavigationBarModel(
        varietyAction: false,
        normalImage: normalImageArray[3],
        activeImage: normalImageArray[3],
        title: navNameArray[3]),
    NavigationBarModel(
        varietyAction: false,
        normalImage: normalImageArray[4],
        activeImage: normalImageArray[4],
        title: navNameArray[4]),
  ];
}
